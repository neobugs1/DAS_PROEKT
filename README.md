# Justice Is Served
Веб апликација која содржи база со сите локации на затвори и затвореници во Македонија.
___
...
- [x] Системот треба биде достапен 99% од времето <code>Edit: Апликацијата е публикувана</code>
...
## Докеризирање успешно

![implementation](https://i.imgur.com/4BNVVBR.png)

## Успешно публикување на Azure со помош на docker-compose

https://github.com/neobugs1/DAS_PROEKT/blob/d1ab275ff45a1e2898f13e8ed34d89885d839016/docker-compose.yml#L1-L28

# About

НОВО: апликацијата е публикувана!
https://composedians.azurewebsites.net/
